...
export default function SudokuGame() {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-center p-4 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`}>
      <h1 className="text-4xl font-bold mb-8 text-primary">Sudoku Master</h1>

      <div className={`${theme === 'dark' ? 'bg-gray-800' : 'bg-gray-200'} rounded-lg shadow-xl p-6`}>
        <GameControls
